...
available_models = whisper.list_available_models()
if "whisper-large-ru" in available_models:
    model = whisper.load_model("whisper-large-ru")
else:
    print("Модель whisper-large-ru не найдена.")
